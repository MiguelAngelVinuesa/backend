...
// RoundSecondRequest Round second spin request.
//
// Execute the second spin of a double-spin slot, calculate the results (including free spins), and return the spin.
//
// swagger:model RoundSecondRequest
type RoundSecondRequest struct {
