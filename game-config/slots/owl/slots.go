...
// New returns a "Owl Kingdom" slot-machine game with the given RTP if possible.
...
// NewLogged return a "Owl Kingdom" slot-machine game with the given RTP if possible and activates PRNG logging.
...
// AllSymbols returns the complete symbol set for Owl Kingdom.
func AllSymbols() *comp.SymbolSet {
	return symbols
}

// Paylines returns the paylines for Owl Kingdom.
...
// AllActions returns the complete list of actions for Owl Kingdom.
