...
// New instantiates a "150 Game" slot-machine game with the given RTP if possible.
...
// NewLogged instantiates a "150 Game" slot-machine game with the given RTP if possible and activates PRNG logging.
...
// NewWithRoundFlags returns an "150 Game" slot-machine game with the given RTP if possible and activates round flag logging.
...
// AllSymbols returns the complete symbol set for 150 Game.
func AllSymbols() *comp.SymbolSet {
	return symbols
}

// Paylines returns the paylines for 150 Game.
...
// AllActions returns the complete list of actions for 150 Game.
