...
// WithPayload adds the payload to the post auth params
func (o *PostAuthParams) WithPayload(payload *models.AuthenticationRequest) *PostAuthParams {
	o.SetPayload(payload)
	return o
}

// SetPayload adds the payload to the post auth params
func (o *PostAuthParams) SetPayload(payload *models.AuthenticationRequest) {
	o.Payload = payload
}
